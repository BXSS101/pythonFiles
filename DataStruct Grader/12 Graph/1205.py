...
อธิบาย Test Case #1
เส้นทางจาก node 1 ไปยัง node 3 มี 3 เส้นทางได้แก่ 1->2->3  ,  1->5->3  ,  1->5->4->3  จากการแสดงผลจะเห็นได้ว่า 1->2->3 แสดงก่อน 1->5->3  เนื่องจาก 2 มีค่าน้อยกว่า 5  จึงแสดงผล 1->2->3 ก่อน 1->5->3
'''